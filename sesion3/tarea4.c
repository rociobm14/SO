...
//no lo entiendo bien, por que salen las cosas 2 veces.
#include <sys/types.h>
#include <unistd.h>
#include <stdio.h>
#include <errno.h>
#include <stdlib.h> //he tenido que añadirla
//¿Penaliza si en el examen escribimos todas las librerías?
...
int main(int argc, char *argv[]){
    ...
    //aquí escribe en el archivo de salida el mensaje que contiene "buf"
